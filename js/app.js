...
if (q5Answer === q5Truth) {
    alert('Ahhh. Your so nice. I promise not to walk around naked in front of the windows.')
    userCorrectAnswers++;
} else {
    alert('Hey, You\'re wrong. I\'m a nice guy. I promise not to walk around naked in front of the windows.')
}
