...
function q6() {
  ...
  // guessing loop
  while (!guessedCorrect && numOfGuesses > 0 ) {
  ...
  alert('There is 100 things on my bucket list');
  userCorrectAnswers++;
}
...
function q7() {
  ...
  var countriesVisitedPrint = ['United States', 'Spain', 'France', 'United Kingdom', 'England', 'Scotland', 'Ireland', 'Italy', 'India', 'Canada', 'Mexico', 'Australia', 'China'];
  var countriesVisited = ['USA', 'US', 'united states of america', 'spain', 'france', 'uk', 'united kingdom', 'england', 'scotland', 'ireland', 'italy', 'india', 'canada', 'mexico', 'australia', 'china'];
  ...
  while (!gotItRightQ7 && numberOfGuessesQ7 > 0) {
    // - propt question
    var userGuessQ7 = prompt('Guess the name of a country I\'ve visited? You have ' + numberOfGuessesQ7 + '/5 guesses').toUpperCase();
  ...
  if (gotItRightQ7) {
    alert('Yep. ' + userGuessQ7 + ' is a country I\'ve visited. I\'ve also visited ' + countriesVisitedPrint);
    userCorrectAnswers++;
  } else {
